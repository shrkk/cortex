...
async def test_run_pipeline_sets_done_on_success():
    ...
    with (
        ...
        patch("app.pipeline.pipeline._stage_extract_stub", new=AsyncMock(side_effect=lambda sid: calls.append("extract"))),
        patch("app.pipeline.pipeline._stage_resolve_stub", new=AsyncMock(side_effect=lambda sid: calls.append("resolve"))),
        patch("app.pipeline.pipeline._stage_edges_stub", new=AsyncMock(side_effect=lambda sid: calls.append("edges"))),
...
async def test_run_pipeline_force_passed_to_parse():
    ...
    with (
        ...
        patch("app.pipeline.pipeline._stage_extract_stub", new=AsyncMock()),
        patch("app.pipeline.pipeline._stage_resolve_stub", new=AsyncMock()),
        patch("app.pipeline.pipeline._stage_edges_stub", new=AsyncMock()),
